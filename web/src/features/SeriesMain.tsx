...
import type { Episode, Genre, Series } from '@prisma/generated/prisma/client'
	...
	return (
		<section className="relative h-[60vh] w-full">
			<div className="absolute bottom-16 left-10 max-w-xl">
				...
				{/* 2 buttons watch now and more info with icons from lucide react. button first white, second gray. from shadcn */}
